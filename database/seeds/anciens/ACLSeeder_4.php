...
class ACLSeeder extends Seeder {
    ...
    public function run() {
        ...
        $article4->description = "La Fondation Hydros a le plaisir d’annoncer l’ouverture des inscriptions pour l’Hydrocontest 2017, qui se tiendra le mois de juillet prochain. Les équipes candidates sont appelées à prendre connaissance du nouveau règlement officiel et à soumettre leurs dossiers complets avant le 31 janvier 2017.
...
Les deux nouveaux prix viennent compléter la liste de trophées hors-course, le premier misant sur l’esthétique des bateaux et le deuxième sur la capacité des étudiants à présenter leurs projets de façon optimale possible lors des Tech Talks.";
