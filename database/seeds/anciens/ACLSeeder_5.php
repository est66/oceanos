...
";
        ...
        $media121->titre = "";
        $media121->url = "http://pingouin.heig-vd.ch/oceanos/storage/documents/24pd.pdf";
        ...
        $media122->titre = "";
        $media122->url = "http://pingouin.heig-vd.ch/oceanos/storage/documents/20pd.pdf";
        ...
        $media121 = new App\Media();
        $media121->titre = "";
        $media121->url = "http://pingouin.heig-vd.ch/oceanos/storage/documents/test1.pdf";
        $media121->description = "";
        $media121->type = "document";
        $media121->article_id = 3;
        $media121->save();

        $media122 = new App\Media();
        $media122->titre = "";
        $media122->url = "http://pingouin.heig-vd.ch/oceanos/storage/documents/test2.pdf";
        $media122->description = "";
        $media122->type = "document";
        $media122->article_id = 4;
        $media122->save();
        //-----------sponsors--------------
